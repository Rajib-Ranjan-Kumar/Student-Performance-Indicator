...
class DataTransformation:
        ...
        try:
          ...
          ("standardscaler", StandardScaler(with_mean=False))
            ...
            preprocessor=ColumnTransformer(
                [
                    ("numerical_pipe",numerical_pipeline,numerical_feature),
                    ("categorical_pipe",categorical_pipeline,categorical_feature)
                ]
            )
            logging.info("completting the columnTransfer")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("fetching the train and test")

            preprocessor_obj=self.get_data_transformer_object()

            logging.info("getting transformation object")
